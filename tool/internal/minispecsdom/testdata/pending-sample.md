...
The work queue. Ordered by intent — the top item is active. A committed sample; not a
real queue.
...
Answers already obtained, kept here until resumed.

## 3. **An old one**. Its body quotes an entry:

```
## 9. **not an entry**. Fenced.
```
