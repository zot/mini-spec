...
**Input:** a root with `carves/x.md` (status block, every part landed) linking `../tool/a.md#s`, `done/old.md`, `other.md` and `nowhere.md`; `carves/other.md` linking `x.md#4`; `carves/done/old.md` linking `../x.md`; a tracked `specs/index.md` linking `../carves/x.md#4`; the ignored `PENDING.md` linking `carves/x.md`; an untracked `.carves/private.md` linking and pointing at `../carves/x.md`; an ignored `DONE.md` whose Part pointer names carves/x.md#1; `carves/done/x-twin.md` that must not be touched, and `carves/done/nowhere.md`, a file the carve never pointed at
**Expected:** `carves/done/x.md` exists with `../../tool/a.md#s`, `old.md`, `../other.md`, `nowhere.md` (left and reported, not retargeted at the twin); `carves/x.md` is gone; `other.md` reads `done/x.md#4`, `old.md` reads `x.md`, `specs/index.md` reads `../carves/done/x.md#4`, `PENDING.md` reads `carves/done/x.md`, the private carve's link and pointer read `../carves/done/x.md` with the key kept, and the ledger's pointer reads `carves/done/x.md#1` (R490, R498: every owned document, both kinds, exactly what `query refs --to` lists); every other byte of every file unchanged; the twin untouched; counts rewritten 10, left 1
